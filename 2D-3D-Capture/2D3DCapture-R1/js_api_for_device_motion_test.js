...
var registerDeviceMotionEvents = function(handlacceleration, handleAccelerationWithGravity, handleRotation){
	...
	window.addEventListener("devicemotion", function(event) {
		...
		if(acceleration ) {
			...
			//document.getElementById("acc").innerHTML="Calculated AX :"+temp.adjustedAX+" AY :"+temp.adjustedAY+" AZ :"+temp.adjustedAZ;
...
//			document.getElementById("gacc").innerHTML="Calculated GAX :"+temp.adjustedGAX+" GAY :"+temp.adjustedGAY+" GAZ :"+temp.adjustedGAZ;
...
//	var value = acceleration.x;
	...
	if(len===10) {		
		for(count = 0; count < len ; count ++)
			document.getElementById("AX"+(count)).innerHTML="<-->"+accx[count];
...
//	value = acceleration.y;
	...
	if(len===10) {
		count = 0;
		for(count = 0; count < len ; count ++)
			document.getElementById("AY"+(count)).innerHTML="<-->"+accy[count];
...
//	value = acceleration.z;
	...
	if(len===10) {
		count = 0;
		for(count = 0; count < len ; count ++)
			document.getElementById("AZ"+(count)).innerHTML="<-->"+accz[count];
		adjustedAZ= adjust(average(accz),0.4);
//		document.getElementById("ave").innerHTML="Calclating "+adjustedAX;
		accz.splice(0, 1); 
	}	
//	document.getElementById("acc").innerHTML="Calclating AX :"+adjustedAX+" AY :"+adjustedAX+" AZ :"+adjustedAX;
	var temp = new Object();
	temp.x = adjustedAX;
	temp.y = adjustedAY;
	temp.z = adjustedAZ;	
//	document.getElementById("ave").innerHTML="Returned AX :"+temp.x+" AY :"+temp.y+" AZ :"+temp.z;
	return temp;
	
};
/**
 * This function would ditermin the down in the context the mobile is used.
 */
var processAccelerationDueToGravity= function(acceleration){
	//document.getElementById("gacc").innerHTML="Calculating GAX :"+acceleration.x+" GAY :"+acceleration.y+" GAZ :"+acceleration.z;
	var adjustedGAX=0;
	var adjustedGAY=0;
	var adjustedGAZ=0;
	var count = 0;
...
//	var value = acceleration.x;
	...
	if(len===10) {		
		for(count = 0; count < len ; count ++)
			document.getElementById("GX"+(count)).innerHTML="<-->"+gaccx[count];
...
//	value = acceleration.y;
	...
	if(len===10) {
		count = 0;
		for(count = 0; count < len ; count ++)
			document.getElementById("GY"+(count)).innerHTML="<-->"+gaccy[count];
...
//	value = acceleration.z;
	...
	if(len===10) {
		count = 0;
		for(count = 0; count < len ; count ++)
			document.getElementById("GZ"+(count)).innerHTML="<-->"+gaccz[count];
...
//		document.getElementById("ave").innerHTML="Calclating "+adjustedAX;
	...
	var temp = new Object();
	//document.getElementById("gacc").innerHTML="Calculated GAX :"+adjustedGAX+" GAY :"+adjustedGAY+" GAZ :"+adjustedGAZ;
	temp.x = adjustedGAX;
	temp.y = adjustedGAY;
	temp.z = adjustedGAZ;
	//document.getElementById("gave").innerHTML="Returned GAX :"+temp.x+" GAY :"+temp.y+" GAZ :"+temp.z;
	return temp;	
};
...
//	document.getElementById("valid").innerHTML="Valid Numbers "+devideBy;
//	document.getElementById("calc").innerHTML="Calculated Average "+ave+":"+sum+":"+devideBy;
	return ave;
};
...
var processOrientationEvent = function (event){
	...
	if(len===10) {		
		for(count = 0; count < len ; count ++)
			document.getElementById("AX"+(count)).innerHTML="<"+alphaValues[count]+">";
	...
	if(len===10) {		
		for(count = 0; count < len ; count ++)
			document.getElementById("AY"+(count)).innerHTML="<"+betaValues[count]+">";
	...
	if(len===10) {		
		for(count = 0; count < len ; count ++)
			document.getElementById("AZ"+(count)).innerHTML="<"+gammaValues[count]+">";
