...
var startWSServer = function() {
	...
	//var url = "http://"+localURL+":"+localPORT+"/TwoDThreeDCapture/DesktopClientMultiplexer?command=get&url="+localURL+":"+remotePort+"/startwebsocketserver";
	var url = "http://dev.cyberlightning.com:17321/startwebsocketserver";
...
var shutdownWSServer = function() {
	var http = new XMLHttpRequest();
	var url = "http://dev.cyberlightning.com:17321/closewebsocketserver";
