...
NyARParam = ASKlass('NyARParam',
{
  ...
  ,getProjectionMatrix : function(znear, zfar) {
    ...
    var fx = p[0][0];
    var fy = p[1][1];
    var fovy = 2 * Math.atan2(height, 2 * fy);
    var aspect = (width/height) * (fy/fx);

    // generate frustum via gluPerspective parameters fovy and aspect
