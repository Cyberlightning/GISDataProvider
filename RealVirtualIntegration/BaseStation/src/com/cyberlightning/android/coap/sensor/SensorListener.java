...
public class SensorListener implements Runnable,SensorEventListener  {
	...
	private CoapBaseStation context;
	private List<Sensor> deviceSensors;
	private String deviceID;

	
	public SensorListener(CoapBaseStation _parent) {
	...
	private String getTimeStamp() {
		return  new SimpleDateFormat(Settings.DATE_FORMAT).format(new Date(System.currentTimeMillis()));
	}
